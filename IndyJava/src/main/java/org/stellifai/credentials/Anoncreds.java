...
public class Anoncreds {
    private static final Logger logger = Logger.getLogger(Anoncreds.class.getName());
    public static void demo() throws Exception {
        ...
        String issuerDid = "R1uCFcU4GYGyb2eZ6e6zhj";
        String proverDid = "~6ZeJECuREQQisfT8pudQvC";
        ...
        logger.info("pool of the Pool: " + pool);
